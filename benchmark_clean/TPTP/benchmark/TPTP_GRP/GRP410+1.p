...
% File     : GRP410+1
% Domain   : Group Theory
% Problem  : Normal subgroup conjugation 11 elements
% Status   : Theorem
% Rating   : 0.65 v1.0.0
% Source   : [GRP]
% SPC      : FOF_THM
...
fof(n6, axiom, ( normal(h6) )).
fof(n7, axiom, ( normal(h7) )).
fof(n8, axiom, ( normal(h8) )).
fof(n9, axiom, ( normal(h9) )).
fof(n10, axiom, ( normal(h10) )).
