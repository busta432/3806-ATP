%--------------------------------------------------------------------------
% File     : SET634+3 : TPTP v8.1.2. Released v2.2.0.
% Domain   : Set Theory
% Problem  : X ^ (Y \ Z) = X ^ Y \ Z
