...
% Problem  : Forall-exists interplay 19 elements
% Status   : Theorem
% Rating   : 0.45 v1.0.0
% Source   : [LCL]
% SPC      : FOF_THM
...
fof(elem11, axiom, ( t(e11) )).
fof(elem12, axiom, ( t(e12) )).
fof(elem13, axiom, ( t(e13) )).
fof(elem14, axiom, ( t(e14) )).
fof(elem15, axiom, ( t(e15) )).
fof(elem16, axiom, ( t(e16) )).
fof(elem17, axiom, ( t(e17) )).
fof(elem18, axiom, ( t(e18) )).
