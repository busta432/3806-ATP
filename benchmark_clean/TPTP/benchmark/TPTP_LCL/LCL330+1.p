...
% Problem  : Branching chain depth 11 branches 4
% Status   : Theorem
% Rating   : 0.45 v1.0.0
% Source   : [LCL]
% SPC      : FOF_THM
...
fof(br0, axiom, ( ! [X] : ((p5(X) => q0(X))) )).
fof(br1, axiom, ( ! [X] : ((p5(X) => q1(X))) )).
fof(br2, axiom, ( ! [X] : ((p5(X) => q2(X))) )).
fof(br3, axiom, ( ! [X] : ((p5(X) => q3(X))) )).
fof(base, axiom, ( p0(c) )).
fof(goal, conjecture, ( p11(c) & q0(c) & q1(c) & q2(c) & q3(c) )).
%------------------------------------------------------------------------------
