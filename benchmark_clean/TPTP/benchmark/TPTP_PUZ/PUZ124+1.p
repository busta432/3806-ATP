...
% File     : PUZ124+1
% Domain   : Puzzles
% Problem  : Reachability 24-step chain
% Status   : Theorem
% Rating   : 0.75 v1.0.0
% Source   : [PUZ]
% SPC      : FOF_THM
...
fof(e17, axiom, ( edge(n16,n17) )).
fof(e18, axiom, ( edge(n17,n18) )).
fof(e19, axiom, ( edge(n18,n19) )).
fof(e20, axiom, ( edge(n19,n20) )).
fof(e21, axiom, ( edge(n20,n21) )).
fof(e22, axiom, ( edge(n21,n22) )).
fof(e23, axiom, ( edge(n22,n23) )).
fof(e24, axiom, ( edge(n23,n24) )).
fof(goal, conjecture, ( reach(n0,n24) )).
%------------------------------------------------------------------------------
