...
% File     : PUZ535+1
% Domain   : Puzzles
% Problem  : Graph coloring 7 nodes 3 colors
% Status   : Theorem
% Rating   : 0.65 v1.0.0
% Source   : [PUZ]
% SPC      : FOF_THM
...
fof(v4_has_color, axiom, ( color(v4,col0) | color(v4,col1) | color(v4,col2) )).
fof(v5_has_color, axiom, ( color(v5,col0) | color(v5,col1) | color(v5,col2) )).
fof(v6_has_color, axiom, ( color(v6,col0) | color(v6,col1) | color(v6,col2) )).
