...
% Problem  : Redundant axiom chain 14 var 2
% Status   : Theorem
% Rating   : 0.65 v1.0.0
% Source   : [CASC]
% SPC      : FOF_THM
...
fof(ax12, axiom, ( ! [X] : ((p12_1(X) => p13_1(X))) )).
fof(ax13, axiom, ( ! [X] : ((p13_1(X) => p14_1(X))) )).
...
fof(skip12, axiom, ( ! [X] : ((p12_1(X) => p14_1(X))) )).
fof(base, axiom, ( p0_1(c_1) )).
fof(goal, conjecture, ( p14_1(c_1) )).
%------------------------------------------------------------------------------
