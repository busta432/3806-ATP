...
% Problem  : Redundant axiom chain 14 var 3
% Status   : Theorem
% Rating   : 0.65 v1.0.0
% Source   : [CASC]
% SPC      : FOF_THM
...
fof(ax10, axiom, ( ! [X] : ((p10_2(X) => p11_2(X))) )).
fof(ax11, axiom, ( ! [X] : ((p11_2(X) => p12_2(X))) )).
fof(ax12, axiom, ( ! [X] : ((p12_2(X) => p13_2(X))) )).
fof(ax13, axiom, ( ! [X] : ((p13_2(X) => p14_2(X))) )).
...
fof(skip10, axiom, ( ! [X] : ((p10_2(X) => p12_2(X))) )).
fof(skip12, axiom, ( ! [X] : ((p12_2(X) => p14_2(X))) )).
fof(base, axiom, ( p0_2(c_2) )).
fof(goal, conjecture, ( p14_2(c_2) )).
%------------------------------------------------------------------------------
