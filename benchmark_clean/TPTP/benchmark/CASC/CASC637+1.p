...
% Problem  : Redundant axiom chain 14 var 1
% Status   : Theorem
% Rating   : 0.65 v1.0.0
% Source   : [CASC]
% SPC      : FOF_THM
...
fof(ax12, axiom, ( ! [X] : ((p12_0(X) => p13_0(X))) )).
fof(ax13, axiom, ( ! [X] : ((p13_0(X) => p14_0(X))) )).
...
fof(skip12, axiom, ( ! [X] : ((p12_0(X) => p14_0(X))) )).
fof(base, axiom, ( p0_0(c_0) )).
fof(goal, conjecture, ( p14_0(c_0) )).
%------------------------------------------------------------------------------
