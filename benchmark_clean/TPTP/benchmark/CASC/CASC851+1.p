...
fof(e16, axiom, ( dominates(x16,x17) )).
fof(e17, axiom, ( dominates(x17,x18) )).
fof(e18, axiom, ( dominates(x18,x19) )).
fof(goal, conjecture, ( dominates(x0,x19) )).
%------------------------------------------------------------------------------
