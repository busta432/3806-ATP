...
fof(e14, axiom, ( connects(x14,x15) )).
fof(e15, axiom, ( connects(x15,x16) )).
fof(e16, axiom, ( connects(x16,x17) )).
fof(e17, axiom, ( connects(x17,x18) )).
fof(e18, axiom, ( connects(x18,x19) )).
fof(goal, conjecture, ( connects(x0,x19) )).
%------------------------------------------------------------------------------
