...
fof(e14, axiom, ( precedes(x14,x15) )).
fof(e15, axiom, ( precedes(x15,x16) )).
fof(e16, axiom, ( precedes(x16,x17) )).
fof(e17, axiom, ( precedes(x17,x18) )).
fof(e18, axiom, ( precedes(x18,x19) )).
fof(goal, conjecture, ( precedes(x0,x19) )).
%------------------------------------------------------------------------------
